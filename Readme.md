...
# Parsing + Configuration Script – BOD - Rev. A

This **Parsing + Configuration** script is designed for the **BOD** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – BOD Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **BOD** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
